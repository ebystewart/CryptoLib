...
int aes_encrypt_init(aes_mode_t mode, int keyLen, char *key, char *initVlaues, char *plain_text, char *ciper_text);
...
/* AES Decryption */
int aes_decrypt_init(aes_mode_t mode, int keyLen, char *key, char *initVlaues, char *cipher_text, char *plain_text);
...
/* Sync APIs */
int aes_encrypt(aes_mode_t mode, int keyLen, char *key, char *initVlaues, char *plain_text, char *ciper_text);

int aes_decrypt(aes_mode_t mode, int keyLen, char *key, char *initVlaues, char *cipher_text, char *plain_text);
