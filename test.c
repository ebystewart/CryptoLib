...
#include "hmac.h"
    ...
    /*
     key: 0x5468617473206D79204B756E67204675458616473702D69702B457E6760264575468617473206D79204B756E67204675458616473702D69702B457E676026457
     Expected hmac: 0xb79b7a849c337f86453860dfdb3b84baf976c48af89f672badd9b29291134fe8
     Observed hmac: 0x2b48fd9f1045e8cdaa10461b5b2c7ce8e53a3836c30b18dbb6f2c7b1d6609a
    */
    uint8_t key[64] = { 0x54, 0x68, 0x61, 0x74, 0x73, 0x20, 0x6D, 0x79, 0x20, 0x4B, 0x75, 0x6E, 0x67, 0x20, 0x46, 0x75,
                        0x45, 0x86, 0x16, 0x47, 0x37, 0x02, 0xD6, 0x97, 0x02, 0xB4, 0x57, 0xE6, 0x76, 0x02, 0x64, 0x57,
                        0x54, 0x68, 0x61, 0x74, 0x73, 0x20, 0x6D, 0x79, 0x20, 0x4B, 0x75, 0x6E, 0x67, 0x20, 0x46, 0x75,
                        0x45, 0x86, 0x16, 0x47, 0x37, 0x02, 0xD6, 0x97, 0x02, 0xB4, 0x57, 0xE6, 0x76, 0x02, 0x64, 0x57 };
    uint8_t digest[32];
    size_t digestLen;
    hmac_generate(message, strlen(message), key, 64, HMAC_SHA2_256, digest, &digestLen);
    printf("The hmac is:\n");
    for(int idx = 0; idx < digestLen; idx++){
        printf("%x", digest[idx]);
    }
    printf("\n");
#endif
...
/*                       run a client        : nc 127.0.0.1 40000             */
