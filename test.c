...
#include "hmac.h"
    ...
    /*
     key: 0x5468617473206D79204B756E67204675458616473702D69702B457E676026457 
     Expected hmac: 0xcd61c4cac22a9fb860f166e0356ab54475bc11cfff47a700585db32e904ebbb7
    */
    uint8_t key[32] = {0x54, 0x68, 0x61, 0x74, 0x73, 0x20, 0x6D, 0x79, 0x20, 0x4B, 0x75, 0x6E, 0x67, 0x20, 0x46, 0x75,
                        0x45, 0x86, 0x16, 0x47, 0x37, 0x02, 0xD6, 0x97, 0x02, 0xB4, 0x57, 0xE6, 0x76, 0x02, 0x64, 0x57};
    uint8_t digest[32];
    size_t digestLen;
    hmac_generate(message, strlen(message), key, 32, HMAC_SHA2_256, digest, &digestLen);
    printf("The hmac is:\n");
